...
The analysis focuses on understanding accident trends, severity, and contributing factors, while also preparing the dataset for future machine learning models to predict accident outcomes.
...
Provide actionable recommendations for traffic safety
...
Accidents are distributed across all days and months
🌦 Weather Conditions
Most accidents occur during clear weather
Rain increases accident risk due to slippery roads
Visibility alone does not prevent accidents
🌆 Lighting Conditions
Highest accidents occur during daylight
Night conditions (even with lighting) still show significant accidents
Dusk and dawn contribute due to low visibility
🚧 Traffic Control Devices
Most accidents occur at traffic signals
...
🔍 Key Insights
Most accidents are caused by driver behavior (distraction, misjudgment)
High traffic volume increases accident probability
Intersections are high-risk areas
Road design significantly impacts accident frequency
Severe injuries are rare but critical
⚠️ Risk Factors
Rush hour congestion
Driver fatigue and stress
Poor visibility during transitions (dusk/dawn)
